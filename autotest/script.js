...
const questions = [
    ...
    new Question("Quel est votre âge ? Ceci, afin de calculer un facteur de risque spécifique. :", ["Entre 0 et 12 ans", "Entre 13 et 24 ans", "Entre 25 et 48 ans", "Entre 49 et 64 ans", "Plus de 65 ans"],[5, 0], null, null),
    ...
    new Question("Avez-vous une maladie respiratoire ? Ou êtes-vous suivi par un pneumologue ?è", ["Oui", "Non"], [5, 0], null, null),
    ...
    new Question("Êtes-vous enceinte ?", ["Oui", "Non", "Nom applicable"], [5, 0, 0], null, null),
...
function onBtnQuesiontSuivantClick(e){
    console.log(autoTest.getQuestionCourante().getNote());
